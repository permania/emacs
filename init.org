...
#+begin_src elisp
(defcustom fixed-width-desired-font "Terminess Nerd Font Mono"
  "Fixed width font."
  :type 'string)

(defun pm/apply-fonts ()
  (set-face-attribute 'default nil :font fixed-width-desired-font :height 130 :weight 'regular)
  (set-face-attribute 'fixed-pitch nil :font fixed-width-desired-font :height 130 :weight 'regular)
